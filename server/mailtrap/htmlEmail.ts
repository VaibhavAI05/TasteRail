export const htmlContent: string = `
    ...
    <body>
        <div class="container">
            ...
            <div class="footer">
                <p>&copy; 2024 TasteRail. All rights reserved.</p>
            </div>
        </div>
    </body>
    </html>
            ...
            <body>
              <div class="email-container">
                ...
                <div class="email-body">
                  ...
                  <p>Best Regards,<br/>The TasteRail Team</p>
                </div>
...
export const generatePasswordResetEmailHtml = ( resetURL: string) => { 
  // const resetURL = `http://localhost:5173/reset-password/${token}`; //change
    return `
      <html>
        <head>
          <style>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              ...
              <p>Thank you,<br/>The TasteRail Team</p>
            </div>
            <div class="email-footer">
              <p>&copy; 2024 tasteRail. All rights reserved.</p>
            </div>
