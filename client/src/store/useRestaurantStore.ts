...
const API_END_POINT = "https://tasterail.onrender.com/api/v1/restaurant"
...
export const useRestaurantStore = create<RestaurantState>()(persist((set, get) => ({
    ...
    searchRestaurant: async(searchText: string, searchQuery: string, selectedCuisines: any) => {
        try {
            ...
            // await new Promise((resolve) => setTimeout(resolve, 500)); skelleton dellay
    ...
    updateMenuToRestaurant: (updatedMenu: MenuItem) => {
        set((state: any) => {
            ...
            //if state.restaurant is undefined return state
            return state;
        })
    },
